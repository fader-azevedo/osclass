  ...
  <div id="upload-plugins">
    ...
    <?php if( is_writable( osc_plugins_path() ) ) { ?>
      <div class="flashmessage flashmessage-info flashmessage-inline" style="display:block;">
        <p class="info"><?php printf( __('You can download and install new plugins directly in %s section.'), '<a href="<?php echo osc_admin_base_url(true); ?>?page=market&action=plugins" target="_blank">' . __('Market > Plugins') . '</a>'); ?></p>
      </div>
