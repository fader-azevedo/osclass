    ...
    <div class="form-horizontal">
      <?php if( is_writable( osc_themes_path() ) ) { ?>
        <div class="flashmessage flashmessage-info flashmessage-inline" style="display: block;">
          <p class="info"><?php printf( __('You can download and install new themes directly in %s section.'), '<a href="<?php echo osc_admin_base_url(true); ?>?page=market&action=themes" target="_blank">' . __('Market > Themes') . '</a>'); ?></p>
        </div>
