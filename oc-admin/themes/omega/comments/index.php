...
<div class="relative">
  <div id="listing-toolbar">
    <div class="float-right">
      ...
      <a href="<?php echo osc_admin_base_url(true) . '?page=comments&showAll=off'; ?>" class="btn"><?php _e('Hidden comments');?></a>
      <?php } else { ?>
      <a href="<?php echo osc_admin_base_url(true) . '?page=comments'; ?>" class="btn"><?php _e('All comments');?></a>
      <?php } ?>
    </div>
  </div>
