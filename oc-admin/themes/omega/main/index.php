          ...
          <?php if(!in_array('glance', $widgets_hidden)) { ?>
            <div class="widget-box" id="widget-glance" data-id="glance">
              ...
              <div class="widget-box-content" <?php echo (osc_admin_widget_collapsed('glance') ? 'style="display:none;"' : ''); ?> >
                ...
                <div class="row"><?php echo sprintf(__('This website is using %s plugins, %s are active and %s are disabled and %s are not installed.'), $plugins_all, $plugins_active, $plugins_disabled, $plugins_notinstalled); ?></div>
              </div>
            </div>
          <?php } ?>
