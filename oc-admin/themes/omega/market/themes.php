...
<div id="market-block" class="<?php echo osc_esc_html($action); ?>">
  <div id="mrkt">
    ...
    <?php if(is_array($products) && count($products) > 0) { ?>
          ...
          <div class="data">
            ...
            <div class="actions">
              <?php if($api_valid) { ?>
                ...
                <?php } else if ($pstat != 'NOT' && $need_update && ($p['b_purchased'] == 1 || $p['i_price'] <= 0) && $compatible_from && $compatible_to && $pstat == 'ACTIVATED') { ?>
                ...
                <?php } else if(($p['b_purchased'] == 1 || $p['i_price'] <= 0) && $pstat == 'ACTIVATED') { ?>
                  <?php 
                    $file_found = false;
                    if(file_exists(osc_base_path() . 'oc-content/themes/' . $info['int_name'] . '/admin/settings.php')) {
                      $file_found = osc_admin_base_url(true) . '?page=appearance&action=render&file=oc-content/themes/' . $info['int_name'] . '/admin/settings.php';
                    } else if(file_exists(osc_base_path() . 'oc-content/themes/' . $info['int_name'] . '/admin/configure.php')) {
                    ...
                    } else if(file_exists(osc_base_path() . 'oc-content/themes/' . $info['int_name'] . '/admin/header.php')) {
      ...
      <?php } ?>
    <?php } else { ?>
      <div class="err"><?php _e('No product found. Try a different search.'); ?></div>
    <?php } ?>
  </div>
</div>
