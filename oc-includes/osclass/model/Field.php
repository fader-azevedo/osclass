...
class Field extends DAO
{
   ...
   * @return bool
   */
  public function insertField($name, $type, $slug, $required, $options, $categories = null, $order = 999) {
    if($slug=='') {
    ...
    $this->dao->insert($this->getTableName(), array( 's_name' => $name, 'e_type' =>$type, 'b_required' => $required, 's_slug' => $slug, 's_options' => $options, 'i_order' => $order));
