...
function osc_language_url($code = '', $pattern = '', $sort = '', $type = 'osclass') {
  ...
  if($code == '' && $pattern == '') {
  return $api_url . '?osclassVersion=' . $osclass_version . '&type=' . $type . '&action=list&sort=' . $sort;
  } else if($code <> '') {
  return $api_url . '?osclassVersion=' . $osclass_version . '&type=' . $type . '&action=find&code=' . $code;
  } else if($pattern <> '') {
  return $api_url . '?osclassVersion=' . $osclass_version . '&type=' . $type . '&action=search&pattern=' . $pattern . '&sort=' . $sort;
  }
}
...
function osc_location_url($code = '', $pattern = '', $sort = '') {
  ...
  if($code == '' && $pattern == '') {
  return $api_url . '?action=list&sort=' . $sort;
  } else if($code <> '') {
  return $api_url . '?action=find&code=' . $code;
  } else if($pattern <> '') {
  return $api_url . '?action=search&pattern=' . $pattern . '&sort=' . $sort;
  }
}
