...
define('SIGMA_THEME_VERSION', '132');


function sigma_home_latest() {
  if( osc_count_latest_items() > 0 && osc_is_home_page()) { ?>
...
osc_enqueue_style('font-awesome', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.14.0/css/all.min.css');
